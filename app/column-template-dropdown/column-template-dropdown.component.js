        ...
        controller: [
            ...
            function colTemplateController($scope, $http, typeFilter) {
                ...
                this.restoreDefault = function() {
                    for (var templ of this.templates) {
                        if (angular.equals(templ.type, this.piTemplatesInUse) && templ.name == "Default") {
                            this.ApplyTemplate(templ);
                            return;
                        }
                    }
                ...
                this.generateDefault = function(piTemplate) {
                    ...
                    // Need to make clone, otherwise they are same reference
                ...
                // POST template/profile to server (Add to templates.json)
